...
from PyQt5.QtWidgets import (QWidget, QListWidget, QLabel, QLineEdit, QPushButton, 
...
class leftWidget(QWidget):
    ...
    def initLayout(self):
        ...
        self.recordWidget.listWidget.listWidget.itemDoubleClicked.connect(self.callMemberForm)
