...
class mainWidget(QWidget):
    ...
    def connectWidgets(self):
        ...
        self.lWidget.recordWidget.listWidget.listWidget.itemDoubleClicked.connect(self.selectCalendar)
        self.rWidget.pendWidget.listWidget.itemDoubleClicked.connect(self.showMemberForm)
